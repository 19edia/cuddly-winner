...
const columns={staff:'id,username,password_hash,role,active',sessions:'token_hash,staff_id,csrf,expires_at',members:'id,ifj,name,game_nick,roblox_username,discord_id,division,verified,suspect,account_kind,allied_gang,member_rank,identity_version,updated_at',used_ifjs:'digest',confirmations:'token,member_id,discord_id,guild_id,expires_at,member_version',reports:'id,member_id,subject,reporter_id,division,reason,status,resolution,reviewed_by',tickets:'id,guild_id,user_id,channel_id,status,closed_by',jobs:'id,kind,payload,status,attempts,error,next_at,message_id',panels:'channel_id,message_id',audit:'id,actor,action,detail'};
