...
export const ID_FIELDS=['GUILD_ID','MEMBER_ROLE_ID','ADMIN_ROLE_ID','VERIFICATION_CHANNEL_ID','WANTED_CHANNEL_ID','TICKETS_CHANNEL_ID','REPORTS_CHANNEL_ID','TICKET_CATEGORY_ID'];
