...
export const categories=[
 ['entry','PORTAL','🚪','public','ENTRADA'],['info','INFORMAÇÕES','📜','public'],['internal','CONVIVÊNCIA','💬','members','DIVISÃO'],['operations','OPERAÇÕES','⚔️','members'],['training','TREINAMENTOS','🎯','members'],['voice','CENTRAL DE CALLS','🎙️','members'],['staff','COMANDO','🛡️','staff','EQUIPE'],['tickets-category','ATENDIMENTOS','🎫','staff','ATENDIMENTOS']
];
...
export const textChannels=[
 ...
 ['news','avisos','📢','info','public'],['hierarchy','hierarquia','👑','info','public'],['alliances','aliancas','🤝','info','public'],
